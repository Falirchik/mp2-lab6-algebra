...
| can_not_create_postfix_with_wrong_var_and_operation_pos |  |
| can_create_postfix_with_right_var_and_operation_pos1 |  |
| can_create_postfix_with_right_var_and_operation_pos2 |  |
| can_create_postfix_with_right_var_and_operation_pos3 |  |
| can_create_postfix_with_right_var_and_operation_pos4 |  |
| can_not_create_postfix_with_wrong_brackets1 |  |
| can_not_create_postfix_with_wrong_brackets2 |  |
| can_not_create_postfix_with_wrong_brackets3 |  |
| can_not_create_postfix_with_wrong_brackets4 |  |
| can_not_create_postfix_with_wrong_brackets5 |  |
| can_not_create_postfix_with_wrong_brackets6 |  |
| can_not_create_postfix_with_oper_as_first_sym |  |
| can_not_create_postfix_with_oper_as_last_sym |  |
| add_var_mas_is_correct |  |
| del_spase_is_correct |  |
...
| operator_assigning_is_correct | корректность работы == |
